class ObserverList{
	...
	constructor(){
		...
		this.oberserverlist = [];
		console.log(this.oberserverlist);
	...
	count(){
		...
		return this.oberserverlist.length;
	...
	remove(index){
		...
		this.oberserverlist.splice(index, 1);

	}

	indexOf(obj){

		for(let i = 0; i < this.oberserverlist.length; i++){
	...
	getObj(index){
		...
		return this.oberserverlist[index];
...
class Subject {
	...
	constructor(){
		...
		this.subjectobserver = new ObserverList;
	...
	removeObserver(observer){
		...
		this.subjectobserver.remove(this.subjectobserver.indexOf(observer));
	...
	notify(counter){
		...
		for( let i = 0; i < this.subjectobserver.count(); i++){
			this.subjectobserver.getObj(i).update(counter);
		}
...
class Task {
	...
	constructor(){
		...
		this.tasksubject.addObserver(this.observer);

		let _showList  = new Display(this.observer);

		this.tasksubject.notify(this.tasklist);
	}
...
let ob1 = document.getElementById('observer1');
let ob2 = document.getElementById('observer2');
let ob3 = document.getElementById('observer3');
...
o1.update = function(value){
	ob1.innerHTML = value;
}

o2.update = function(value){
	setTimeout(function(){
		ob2.innerHTML = value;
	}, 100)
}

o3.update = function(value){
	ob3.innerHTML = value;
}
*/
